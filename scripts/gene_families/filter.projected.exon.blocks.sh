...
perl ${pathScripts}/filter.projected.exon.blocks.pl --pathExonBlocks=${pathExons}/${prefix}.txt --pathProjectedExons=${pathProjections}/From${ref}_To${tg}_${prefix}.bed --collapse=1000 --minSizeRatio=${minsizeratio} --maxSizeRatio=${maxsizeratio} --pathOutputFilteredExons=${pathProjections}/From${ref}_To${tg}_${prefix}_FilteredProjectedExons_Step1.txt  --pathOutputRejectedExons=${pathProjections}/From${ref}_To${tg}_${prefix}_RejectedProjectedExons_Step1.txt --pathOutputLog=${pathScripts}/logs/log_filter_exon_blocks_from${ref}_to${tg}.txt
